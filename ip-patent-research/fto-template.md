...
| :--- | :--- | :--- | :--- | :--- | :--- |
| *Example: US1234567B2* | *Global Pharma Corp* | *2032-05-12* | *Claim 1: A sustained-release matrix comprising drug X...* | *Medium* | *Modify the excipient ratio to fall outside the claimed 5-10% range.* |
| | | | | | |

## 5. Risk Assessment Framework
*   **Literal Infringement Analysis:** Evaluation of whether the target product meets every single element of an active independent claim.
*   **Doctrine of Equivalents (DoE) Assessment:** Evaluation of whether a modified element performs substantially the same function in substantially the same way to achieve the same result.

## 6. Recommendations & Legal Disclaimer
*Strategic advice on whether to proceed, seek a license, or execute a design-around approach.*
